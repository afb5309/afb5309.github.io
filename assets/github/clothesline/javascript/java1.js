    ...
    $.ajax({
        ...
        if (response === undefined) {
            ...
            if ((description.includes("snow")) || (description.includes("Snow"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/snow.png");
                $("#outside-img").attr("src", "clothesline/images/snowy-cover.jpg");
            } else if ((description.includes("sun")) || (description.includes("Clear")) || (description.includes("clear")) || (description.includes("Sun"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/sun.png");
                $("#outside-img").attr("src", "clothesline/images/sunny-day.jpg");
            } else if ((description.includes("rain")) || (description.includes("Rain"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/rain.png");
                $("#outside-img").attr("src", "clothesline/images/rainyday.jpg");
            } else if ((description.includes("thunder")) || (description.includes("Thunder"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/thunder.png");
                $("#outside-img").attr("src", "clothesline/images/stormy-day.jpg");
            } else if ((description.includes("Scattered clouds")) || (description.includes("Few clouds"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/partly-cloudy.png");
                $("#outside-img").attr("src", "clothesline/images/partly-cloudy-day.jpg");
            } else if ((description.includes("clouds")) || (description.includes("Clouds")) || (description.includes("cloudy")) || (description.includes("Cloudy"))) {
                $("#weather-img").attr("src", "clothesline/images/icons/cloudy.png");
                $("#outside-img").attr("src", "clothesline/images/cloudy-day.jpg");
            }
            ...
            function umbrella(rowPlace) {
                ...
                umbrellaPhoto = $("<img>").attr("src", "clothesline/images/umbrella.jpg").attr("data-clothing", "umbrella-compact").addClass("card-img-top");
            ...
            if (averageTemp <= 34) {
                if ((description.includes("snow")) || (description.includes("Snow"))) {
                    ...
                    addItem("#card-row-1", "parka1", "parka", "parka-coat", "clothesline/images/parka.jpeg", "Wear a parka");
                    addItem("#card-row-1", "hat1", "hat", "beanie-warm", "clothesline/images/hat.jpg", "Bring a hat");
                    addItem("#card-row-1", "gloves1", "gloves", "warm-gloves", "clothesline/images/gloves.jpg", "Take gloves");
                    $("#card-row-2").append("<h4 class='clearfix col-md-12'style=' clear: both; color:white';>Add-Ons<br></h4>");
                    addItem("#card-row-2", "socks1", "socks", "wool-socks-adults", "clothesline/images/socks.jpg", "Wear warm socks");
                    addItem("#card-row-2", "scarf1", "scarf", "warm-scarf", "clothesline/images/scarf.jpg", "Consider a scarf");
                    addItem("#card-row-2", "snow-boots1", "snowBoots", "snow-boots-winter", "clothesline/images/snowBoots.jpg", "Don't forget snow boots")


                } else {
                    addItem("#card-row-1", "parka1", "parka", "parka", "clothesline/images/parka.jpeg", "Wear a parka");
                    addItem("#card-row-1", "hat1", "hat", "warm-gloves", "clothesline/images/hat.jpg", "Bring a hat");
                    addItem("#card-row-1", "gloves1", "gloves", "warm-gloves", "clothesline/images/gloves.jpg", "Take gloves");
                    $("#card-row-2").append("<h4 class='clearfix col-md-12'style=' clear: both; color:white';>Add-Ons<br></h4>");
                    addItem("#card-row-2", "socks1", "socks", "wool-socks", "clothesline/images/socks.jpg", "Wear warm socks");
                    addItem("#card-row-2", "scarf1", "scarf", "warm-scarf", "clothesline/images/scarf.jpg", "Consider a scarf");
                }

            } else if ((averageTemp > 34) && (averageTemp < 50)) {
                addItem("#card-row-1", "coat1", "coat", "coat-winter-warm", "clothesline/images/coat.jpg", "Wear a coat");
                addItem("#card-row-1", "hat1", "hat", "warm-gloves", "clothesline/images/hat.jpg", "Bring a hat");
                addItem("#card-row-1", "scarf1", "scarf", "warm-scarf", "clothesline/images/scarf.jpg", "Consider a scarf");

            } else if ((averageTemp >= 50) && (averageTemp <= 60)) {
                if (windSpeed >= 14) {
                    addItem("#card-row-1", "jacket1", "jacket", "jacket-vintage-clothing", "clothesline/images/jacket.jpg", "Wear a jacket");
                    addItem("#card-row-1", "windbreaker1", "windbreaker", "windbreaker-jacket", "clothesline/images/windbreaker.jpg", "Consider a windbreaker");
                } else {
                    addItem("#card-row-1", "jacket1", "jacket", "jacket-vintage-clothing", "clothesline/images/jacket.jpg", "Wear a jacket");
                }
            } else if ((averageTemp >= 61) && (averageTemp < 70)) {
                addItem("#card-row-1", "lightJacket1", "lightJacket", "jacket-vintage", "clothesline/images/lightJacket.jpg", "Take a light jacket or sweater")
            } else if ((averageTemp >= 70) && (averageTemp <= 75)) {
                addItem("#card-row-1", "sweater1", "sweater", "sweater-vintage", "clothesline/images/sweater.jpg", "Consider taking a light sweater")
            } else if (averageTemp >= 76) {
                addItem("#card-row-1", "tshirt1", "tshirt", "t-shirt-vintage-clothing", "clothesline/images/tshirt.jpg", "Wear something lite, consider a t-shirt")
                addItem("#card-row-1", "shorts1", "shorts", "shorts-vintage-clothing", "clothesline/images/shorts.jpg", "Maybe some shorts")
                addItem("#card-row-1", "sandals1", "sandals", "sandals-shoes", "clothesline/images/sandals.jpg", "Consider wearing sandals")
            }

            if (averageTemp >= 70) {
                if ((description.includes("sun")) || (description.includes("Clear")) || (description.includes("clear")) || (description.includes("Sun"))) {
                    $("#card-row-2").append("<h4 class='clearfix col-md-12'style=' clear: both; color:white';>Add-Ons<br></h4>");
                    addItem("#card-row-2", "sunglasses1", "sunglasses", "sunglasses-vintage", "clothesline/images/sunglasses.jpg", "Bring sunglasses")
                }
            }
            ...
            if (averageTemp >= 35) {
                if (pop >= 40) {
                    $("#card-row-2").append("<h4 class='clearfix col-md-12'style=' clear: both; color:white';>Add-Ons<br></h4>");
                    umbrella("#card-row-2")
                    addItem("#card-row-2", "rainBoot1", "rainBoots", "rain-boots-rubber", "clothesline/images/rainBoots.jpg", "Consider wearing rain boots")
                    addItem("#card-row-2", "rainJacket1", "rainJacket", "rain-jacket", "clothesline/images/rainJacket.jpg", "Think about a rain jacket");
                }
            }
        }
    });
